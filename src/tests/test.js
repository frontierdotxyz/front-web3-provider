...
const frontier = window.frontier;
...
describe("TrustWeb3Provider constructor tests", () => {
  ...
  test("test Solana setAddress", () => {
    const provider = new frontier.SolanaProvider({
      solana: {
    ...
    expect(provider.isFrontier).toBeTruthy();
  ...
  test("test setConfig", (done) => {
    const provider = new frontier.Provider({ ethereum: ropsten });
    const web3 = new Web3(provider);
  ...
  test("test eth_chainId", (done) => {
    const provider = new frontier.Provider({ ethereum: bsc });
    const web3 = new Web3(provider);
  ...
  test("test eth_accounts", (done) => {
    const provider = new frontier.Provider({ ethereum: mainnet });
    const web3 = new Web3(provider);
